...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/holidays-ext-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/holidays-ext-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add holidays-ext
# for installing globally
pixi global install holidays-ext
```
...
It is possible to list all of the versions of `holidays-ext` available on your platform:
...
```
pixi search holidays-ext --channel conda-forge
```
